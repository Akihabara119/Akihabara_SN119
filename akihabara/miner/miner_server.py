...
def load_environment():
    ...
    logging.info("Loading Miner environment configuration...")
...
from akihabara.miner.server import app
from akihabara.miner.env_loader import load_miner_environment, validate_miner_environment
import uvicorn
