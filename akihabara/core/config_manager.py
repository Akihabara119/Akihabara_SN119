...
from akihabara.core.config_client import ConfigClientSync

from akihabara.core.constants import DEFAULT_PENALTY_COEFFICIENT, OWNER_DEFAULT_SCORE
...
class ConfigManager:
    ...
    def __init__(self, config_url: Optional[str] = None, validator_token: Optional[str] = None,
        ...
        base_url = os.getenv("CONFIG_SERVER_URL", "http://config.akihabara.media:8000")
