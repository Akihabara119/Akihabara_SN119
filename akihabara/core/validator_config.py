...
from akihabara.core.constants import TESTNET_NETUID
...
class ValidatorConfig:
    ...
    validator_token: str = ""
    validator_config_url: str = "http://config.akihabara.media:8000/api/validator/config?ver=1.0.1"
    config_server_url: str = "http://config.akihabara.media:8000"
...
def load_validator_config() -> ValidatorConfig:
    ...
    validator_config_url = os.getenv("VALIDATOR_CONFIG_URL", "http://config.akihabara.media:8000/api/validator/config?ver=1.0.1")
    config_server_url = os.getenv("CONFIG_SERVER_URL", "http://config.akihabara.media:8000")
...
def create_test_config() -> ValidatorConfig:
    ...
    return ValidatorConfig(
        ...
        validator_config_url="http://config.akihabara.media:8000/api/validator/config?ver=1.0.1",
        config_server_url="http://config.akihabara.media:8000",
